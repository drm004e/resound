...
#include "resound_client/pch.h" // precompiler header

#include "resound_client/automation.h"
#include "resound_client/pvar.h"
#include "resound_client/behaviour.h" // inheriting class's header file
#include "resound_client/basebehaviour.h" // class's header file

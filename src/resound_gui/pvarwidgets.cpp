...
#include "sa_pvar.h"
#include "sa_comms.h"
#include "sa_amclient.h" // possible circular dep here requires pvar and comms
#include "sa_vumeterwidget.h"

#include "sa_pvarwidgets.h" // class's header file
...
{ // update the link
	...
	if(showMeters) {
		...
		for(int n = 0; n < numMeters; n++) {
			PVarVUMeterWidget* widget = new PVarVUMeterWidget(this,-1,0,0,128,_T("image/tinyMeterOff.bmp"), _T("image/tinyMeterOn.bmp"));
